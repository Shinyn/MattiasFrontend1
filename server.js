  ...
  res.json({
    ...
    endpoints: {
      ...
      "/api/content/:filename":
        "returns files included in current environment. .md or .json",
      "/api/content/render/:filename":
        "returns markup from .md files, parsed with markedjs.",
    },
  });
});
